...
clf;
figure(1)
plot(t,x,'b','linewidth',2.5), hold on
plot(tdata,xdata,'ko','linewidth',2), hold on
x_dax=x_da(:,1);
plot(t,x_dax,'r','linewidth',2.5),hold off
xlabel t; ylabel x;
title('Data Assimilation for $\sigma_{2}$=$\sigma_{3}=0.15$','interpreter','latex')
legend('Solution','Data','Data Assimilation')
